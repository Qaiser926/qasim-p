...
import '../../app/mobules/tourPage/tourView/searchTourDistination.dart';
...
class AppPages {
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
      name: Routes.TravelsBottonNavigation,
      page: () => TravelsBottonNavigation(),
      // binding: SplashBinding(),
    ),
    GetPage(
      name: Routes.home,

...
class TravelsBottonNavigation extends StatefulWidget {
  @override
  State<TravelsBottonNavigation> createState() =>
      _TravelsBottonNavigationState();
}
class _TravelsBottonNavigationState extends State<TravelsBottonNavigation> {
  int currentIndex = 0;

...
class _FlightDetailPageState extends State<FlightDetailPage> {
  ...
  Future<void> getUserApi() async{
   ...
   if (respons.statusCode == 200) {
     ...
     dataList = jsonDecode(data.body)["segments"];

     final firstItem = dataList.first;
     print('First: ${firstItem.departure_airport} - Last: ${firstItem.departure_code}');
  ...
  Widget build(BuildContext context) {
    ...
    String fromResult = (pos != 0) ? from.substring(0, pos) : from;
    String to = widget.to.toString().toUpperCase();
    var poss = to.lastIndexOf(' ');
    String toResult = (poss != 1) ? to.substring(0, poss) : to;
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Column(
              children: [
                mainHeaderContainer(fromResult, toResult),
                  ...
                  if(snapshot.connectionState==ConnectionState.waiting){
                    ...
                    return  ListView.builder(
                      ...
                      itemBuilder: (context,index){
                        return   Container(
                          margin: EdgeInsets.only(left: Dimensions.textsize15,top: Dimensions.fontSize20,bottom:  Dimensions.paddingLeft10,right:  Dimensions.textsize15),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Icon(Icons.airplanemode_active,color: Colors.grey,size: Dimensions.fontSize25*2,),
                              // Text(data[index]['arrival_code'].toString())

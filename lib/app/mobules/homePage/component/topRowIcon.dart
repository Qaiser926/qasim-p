...
class _TopRowIconState extends State<TopRowIcon> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<HomeOfferListModelClass>(
          ...
          return Container(
            ...
            child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final itemData = snapshot.data?.modules;
                  ...
                  String str = capitalizeAllWord(itemData?[index].name ?? "");
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsets.symmetric(
                            horizontal: Dimensions.textsize15),
                        child: InkWell(
                          onTap: () {
                          ...
                          child: Center(
                            child: Container(
                              ...
                              // ),
                              child: Padding(
                                padding: EdgeInsets.all(Dimensions.fontSize17),
                                child: Container(
                                    decoration:

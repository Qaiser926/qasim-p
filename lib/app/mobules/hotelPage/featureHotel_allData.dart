...
class FeatureHotelAllList extends StatefulWidget {

  @override
  State<FeatureHotelAllList> createState() => _FeatureHotelAllListState();
}

class _FeatureHotelAllListState extends State<FeatureHotelAllList> {
  // final controller = Get.find<HomeController>();
  int currentIndex = 0;
  final PageController pageController = PageController();
  double height = 0;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Padding(
          ...
          child: Image.network(imgurl,width: Dimensions.containerHeight65*2,),
        ),
        ...
        child: Stack(
          children: [
            Padding(
              ...
              child: Expanded(
                child: Container(
                  margin: EdgeInsets.only(top: Dimensions.textsize15),
                    decoration: BoxDecoration(
                      // color: Colors.white,
                      // border: Border.all(color: Colors.grey.shade200, width: 0.7),
                      borderRadius: BorderRadius.circular(8.0),
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      boxShadow: const [
                                        BoxShadow(
                                          ...
                                          blurRadius: 3,
                                          spreadRadius:0.8,
                                          offset: Offset(0.4, -0.6), // shadow direction: bottom right
                                        )
                                      ],
                                    ),

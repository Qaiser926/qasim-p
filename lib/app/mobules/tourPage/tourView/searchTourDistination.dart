...
class SearchTourDistination extends StatefulWidget {
  @override
  State<SearchTourDistination> createState() => _SearchTourDistinationState();
}

class _SearchTourDistinationState extends State<SearchTourDistination> {
  dynamic argumentData = Get.arguments;
